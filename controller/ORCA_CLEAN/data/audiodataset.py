...
from data import signal as signal
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.freq_compression == "linear":
            ...
            raise ValueError("Undefined frequency compression '{}'".format(self.freq_compression))
            # raise "Undefined frequency compression {}".format(self.freq_compression)
